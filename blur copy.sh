...
# Android.bp
cat > device/lge/msm8996-common/rro_overlays/SystemUIOverlayMsm8996/Android.bp << 'EOF'
runtime_resource_overlay {
    name: "SystemUIOverlayMsm8996",
    resource_dirs: ["res"],
    vendor: true,
}
EOF
...
# AndroidManifest.xml
cat > device/lge/msm8996-common/rro_overlays/SystemUIOverlayMsm8996/AndroidManifest.xml << 'EOF'
...
cat > device/lge/msm8996-common/rro_overlays/SystemUIOverlayMsm8996/res/values/config.xml << 'EOF'
<?xml version="1.0" encoding="utf-8"?>
...
sed -i '/^    WifiOverlay \\$/a\    SystemUIOverlayMsm8996 \\' device/lge/msm8996-common/msm8996.mk