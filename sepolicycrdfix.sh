...
grep -q 'mitigate mm-qcamera-daemon PDAF race' kernel/lge/msm8996/drivers/media/platform/msm/camera_v2/sensor/actuator/msm_actuator.c && echo "already applied, skipping" || curl -sL https://raw.githubusercontent.com/xc112lg/lg_releases/refs/heads/main/msm_actuator_claf_delay.patch | patch -d kernel/lge/msm8996 -p1